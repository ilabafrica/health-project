...
public class ANVRegistrationActivity extends AppCompatActivity {


    private CoordinatorLayout rootLayout;
    private WidgetHelper widgets;
    private Context context = ANVRegistrationActivity.this;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_anv_clinical_assessment);
